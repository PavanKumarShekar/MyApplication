...
public class ElevatorMalfunctionActivity extends Activity {
    private EditText etother,etincident,ethowmany;
    private RadioButton rbyes,rbno,rbblocka,rbblockb,rbblockc,rbblockd,rbother;
    private String quesblock,quesyesorno,queshowmany,quesincident;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.report_one);
    ...
    private void setvalues() {
        ...
        queshowmany=ethowmany.getText().toString();

        Log.d("quesincident",""+quesincident);
        Log.d("quesyesorno",""+quesyesorno);
        Log.d("quesblock",""+quesblock);

        if(queshowmany.contentEquals("")||quesincident.contentEquals("")){
            ...
            Intent intent =new Intent(ElevatorMalfunctionActivity.this,ReportLoggerActivity.class);
            intent.putExtra("comingFrom","ElevatorMalfunctionActivity");
            intent.putExtra("queshowmany",queshowmany);
